...
// the one defined in tomcrypt_custom.h does not seem to work. So, I put it here
//#define LTC_PRESENT
...
extern const struct ltc_cipher_descriptor present_desc;
#endif
